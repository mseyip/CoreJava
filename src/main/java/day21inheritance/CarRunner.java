...
public class CarRunner {
    ...
    public static void main(String[] args) {
        ...
        //2) When a class has multiple constructors to select the constructor we need, we use super() with parameters
        ...
        /*
            ...
            3)In te first line of every constructor there is invisible "super()" to call default constructor
              from the parent class, if you want you type it explicitly.
