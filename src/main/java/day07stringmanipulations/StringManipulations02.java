...
public class StringManipulations02 {
    ...
    public static void main(String[] args) {
        ...
        String result1 = str.replace('O', '*');// replace(oldChar:'', newChar:''); ==> Tanimli olan bir String'in
                                                            // (oldChar'') eski degerinin, (newChar'') yeni degeri ile yer degistirmesidir.
        System.out.println(result1);//Java is **P

        String result2 = str.replace("Java", "*");// replace(target:'', replacement:''); ==> Tanimli olan bir String'in
                                                    // (target'') bir kelimesinin, (replacement'') yeni bir character ile yer degistirmesidir.
        ...
        System.out.println("Is the password valid? " + (firstRule && secondRule));//True
