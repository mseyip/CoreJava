...
public class IfStatement01 {
    public static void main(String[] args) {
        ...
        //Example 1: Type code to print negative for the numbers less than zero, non-negative for the numbers greater than
        //equal to zero.
        ...
        //"Not divisible by 5" if the number cannot be divided by 5.
        ...
        //       If you type the code like in the second way i)You will prevent repetition ii)Java will execute your
        //          code faster.
        int k=15;
        if (k%5==0){
            System.out.println("Divisible by 5");
